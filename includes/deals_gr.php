<div class="holder" class="desctext">
	<h2 class="header" align="center">Smart Deals</h2>
	<div class="subtitle" align="center">Σε αυτή την ενότητα μπορείτε να βρείτε προσφορές που αφορούν τους φοιτητες</div>
