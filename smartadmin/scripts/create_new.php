...
<div class="create_style">Διαχείριση &rsaquo; Νέα &rsaquo; Δημιουργία νέας Είδησης</div>
<br />
<form id="check" name="create_article" action="scripts/insert_new.php" method="post">
